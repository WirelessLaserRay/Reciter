...
function QuickTestView(props: ModeViewProps) {
  ...
  // 快速测试（熟练卡秒答）：
  // Windows 桌面端（isDesktop）：看中文释义拼写英文单词（中译英填空），带首字母掩码提示；
  // Web / 移动端（!isDesktop）：看中文释义选英文单词（中译英 4 选 1 选项题），避免软键盘遮挡。
  // 仅在当前卡片缺失中文释义时，移动端才切换为看单词选释义（英译中）。
