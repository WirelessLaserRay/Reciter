...
- **每日一文**：主页新增入口，从 China Daily / CNN / Reuters 拉取热点文章，AI 出题并提供参考答案；侧边栏 AI 识别生词（含词性/释义）并支持讲解、导入单独词库；文章可收藏；词汇标准可调（四级/六级/考研/专业英语）
...
- **每日一文 RSS 修复**：支持 CDATA 内容解析；CNN / Reuters 改用 Google News 聚合，避免列表为空或 502
