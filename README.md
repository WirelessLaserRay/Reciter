...
| 🤖 AI 学习助手 | AI 多轮对话面板（学习页右侧可折叠侧栏）、FSRS 自适应策略、JSON 结构化 Prompt、弱词本、AI 配置向导 | ✅ 6B / 0.11.0 |
| 🧬 统一学习流 | 按 FSRS 状态自适应切换：新卡教学 → 主动回忆 / 快速测试 / AI 深度攻克 / 经典翻转；Markdown 语境沉浸、词库掌握度全景、标签集完成后选择/填空巩固测试 | ✅ 6C / 0.11.0 |
| 🎨 多主题外观 | 明暗模式 × 6 套强调色（中性/海蓝/森林/星紫/暖橙/玫红），增强边框对比度，左侧导航可折叠为图标栏 | ✅ 0.11.0 |
...
- **安装分发**：运行 `Reciter_0.11.0_x64-setup.exe` 安装到系统，获得开始菜单/桌面图标与卸载程序
